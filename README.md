...
Задайте еднократно парола за потребителя `admin`, след което влезте в системата. След първоначалното задаване паролата не може да бъде сменяна през публичния екран.
