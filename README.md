...
Ако искате backend да сервира готовия React build:
...
Съдържа SQL структурата на базата данни.

```text
backend/.env
```

Съдържа локални настройки за база данни и JWT. Този файл не се качва в GitHub.

```text
frontend-react/src/App.jsx
```

Основен React файл с интерфейса на приложението.

```text
frontend-react/src/api.js
```

Файл за заявките към backend API.
